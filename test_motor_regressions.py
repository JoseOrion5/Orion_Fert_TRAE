    ...
    def test_quelante_prioritized_for_fe_high_ph(self):
        ...
        insumos = [
            motor.Insumo(
                ...
                solubilidade="Alta",
                natureza_fisica="Sólida",
                teor_por_nutriente_pct={"Fe": 10.0},
                rank_solubilidade=3,
                rank_custo=1,
                preco_unit=1.0,
            )
        ...
        edta = motor.Aditivo(
            ...
            abreviatura="EDTA",
            funcao_principal="Quelante",
            nutrientes_compativeis="Fe",
            faixa_ph_ideal="4.0-7.0",
            dose_maxima_legal_pct="10.0",
            dose_maxima_tecnica_pct="10.0",
            modo_aplicacao="",
            alerta_incompatibilidade="",
            observacoes="",
            preco_unit=10.0,
        ...
        hbed = motor.Aditivo(
            ...
            funcao_principal="Quelante",
            nutrientes_compativeis="Fe",
            faixa_ph_ideal="6.0-9.0",
            dose_maxima_legal_pct="5.0",
            dose_maxima_tecnica_pct="5.0",
            modo_aplicacao="",
            alerta_incompatibilidade="",
            observacoes="",
            preco_unit=10.0,
        ...
        steps, ad_sug = motor.recommend_process_and_aditivos(
            {"Fe": 1.0},
            lines,
            [edta, hbed],
            insumos,
