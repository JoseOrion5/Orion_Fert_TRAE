...
def main() -> int:
    ...
    ap.add_argument("--file1", default=r"COMPLETAO\BACKUP\2.2 Claude-fertilizantes_precos_kg.xlsx")
    ap.add_argument("--file2", default=r"COMPLETAO\BACKUP\2.2-Fertilizantes_solidos_BR_AZ_com_precos_alibaba.xlsx")
    ap.add_argument("--base", default=r"COMPLETAO\2-BASE_UNICA_COM_PRECOS_E_MAX_INFO_COM_FONTES.xlsx")
    ap.add_argument("--out", default=r"COMPLETAO\DATABASE_MESTRE_ORION.xlsx")
    args = ap.parse_args()
